...
function SearchPw({ backSearchModal, target, handleClose }) {
  ...
  const searchPassword = async () => {
    ...
    const res = await axios('https://delivery-mate.herokuapp.com/search/pw', {
      method: 'POST',
      data: obj,
      headers: new Headers(),
    });
  ...
  const changePassword = async () => {
    ...
    await axios('https://delivery-mate.herokuapp.com/update/pw', {
      method: 'POST',
      data: obj,
      headers: new Headers(),
    });
